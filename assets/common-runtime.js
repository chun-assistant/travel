...
const COMMON_STATUS = window.TravelCommonStatus;
...
const currentTripDay = COMMON_STATUS.currentTripDay;
const renderCountdown = COMMON_STATUS.renderCountdown;
const renderNetwork = COMMON_STATUS.renderNetwork;
const renderNotices = COMMON_STATUS.renderNotices;
