...
(function () {
  ...
  var statusSrc = base + "modules/common-status.js";
  ...
  if (document.readyState === "loading" && document.write) {
    ...
    document.write('<script src="' + statusSrc + '"><\\/script>');
  ...
  var scripts = [packingDataSrc, printDataSrc, coreDataSrc, utilsSrc, statusSrc, legacySrc, base + "modules/flight-badges.js"];
  if (isDailyPage) {
    scripts.push(
